...
apt-get install -y apache2 php7.3 php7.3-soap mariadb-server php7.3-mysql libapache2-mod-php7.3 php7.3-xml php7.3-gd php7.3-curl php7.3-xmlrpc php7.3-intl php7.3-zip php7.3-mbstring
